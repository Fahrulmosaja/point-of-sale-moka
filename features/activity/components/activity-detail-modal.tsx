    ...
    <Dialog open={open} onOpenChange={onClose}>
      <DialogContent className="max-w-lg">
        <DialogHeader>
          ...
          <DialogDescription>
            {formatDate(sale.date)} · {typeMap[sale.type]} · {sale.paymentMethod} · {sale.cashierName}
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="flex flex-col gap-3 my-2">
          ...
          <div className="flex flex-col gap-1.5 text-sm">
            ...
            <div className="flex justify-between text-muted-foreground">
              <span>Tax (10%)</span><span>{formatCurrency(sale.tax)}</span>
            </div>
              ...
              <AlertDialogContent>
                <AlertDialogHeader>
                  ...
                  <AlertDialogDescription>
                    This will mark invoice <strong>{sale.invoiceNumber}</strong> as refunded.
                  </AlertDialogDescription>
                </AlertDialogHeader>
                <AlertDialogFooter>
